    ...
    <>
      ...
      <div className="flex flex-col container m-auto h-screen justify-between scroll-smooth">
        <header className="mt-16 drop-shadow-lg">
          <div className="wallpaper w-full h-80 p-5 bg-gradient-to-r from-green-700 via-green-600 to-green-500">
            ...
            <div className="mb-0 mt-10 xl:w-4/5">
              ...
              <div className="input-group inline-flex items-stretch w-full">
                ...
                onChange={(e) => setSearch(e.target.value)}
                  className="form-control relative flex-auto min-w-0 block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-900 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
              ...
              <label className="text-gray-700">Filter tempat diturunkannya surat</label>
                <div>
                  <select 
        ...
        {dataSurah === null ? (
          ...
          <ListAyat dataSurah={dataSurah} handleView={handleView} search={search}/>
        )}
